            ...
            <div className='bg-[#121212] h-[85%] rounded'>
                <div className='p-4 flex items-center justify-between'>
                    <div className='flex items-center gap-3'>
                        ...
                        <p className='text-semibold'>Your Library</p>
                    </div>
                    <div className='flex items-center gap-3'>
                ...
                <div className='p-4 bg-[#242424] m-2 rounded font-semibold flex flex-col items-start justify-start gap-1 pl-4'>
                    ...
                    <button className='bg-white text-[15px] text-black px-4 py-1.5 rounded-full mt-4'>Create playlist</button>
                </div>
                <div className='p-4 bg-[#242424] m-2 rounded font-semibold flex flex-col items-start justify-start gap-1 pl-4 mt-4'>
                    <h1>Let&apos;s find some podcasts to follow</h1>
                    <p className='font-light'>We will keep you updated on new episodes</p>
                    <button className='bg-white text-[15px] text-black px-4 py-1.5 rounded-full mt-4'>Browse podcasts</button>
                </div>
            </div>
        </div>
    )
