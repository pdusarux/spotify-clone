    ...
    return (
        <div>
            ...
            {songsData.map((song, index) => (
                <div key={song.id} className="grid grid-cols-3 sm:grid-cols-4 gap-2 p-2 items-center text-[#a7a7a7] hover:bg-[#ffffff2b] cursor-pointer">
                    <p className="text-white">
                        <b className="mr-4 text-[#a7a7a7]">{index + 1}</b>
                        <img className="w-10 inline mr-5" src={song.image} alt="song" />
                        {song.name}
                    </p>
                    <p>{album.name}</p>
